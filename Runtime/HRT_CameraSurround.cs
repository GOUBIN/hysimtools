...
public class HRT_CameraSurround : MonoBehaviour
{
    ...
    public float maxDistance = 10;//缩放
    public float minDistance = 1f;//缩放
    public float xSpeed = 200.0f;//速度
    public float ySpeed = 200.0f;
    public int yMinLimit = -30;//限定角度
    ...
    public float X = 35;//初始化角度X轴
    public float Y = 0;//初始化角度Y轴
    /// <summary>
    /// 初始化距离
    /// </summary>
    public float CameDistance = 4.8f;
    void Start()
    {
        Init();
    ...
    public void Init()
    {
        ...
        if (!target)
        {
            GameObject go = GameObject.Find("Cam Target") ?? new GameObject("Cam Target");
